 ...
 */
public class MultArrayTest extends LoadJson {

    private final static String expectPath = "array/MultArraysExpect.json";

    private final static String actualPath = "array/MultArraysActual.json";

...
public abstract class AbstractObjectHandle extends AbstractDiffHandle implements ObjectHandle {
    ...
    @Override
    public JsonCompareResult handle(DiffJsonObject expectObject, DiffJsonObject actualObject) {
        // 忽略的path
    ...
    protected abstract void doHandle(DiffJsonObject expectObject, DiffJsonObject actualObject);
}
